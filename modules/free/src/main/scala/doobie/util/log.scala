...
object log {
  ...
  /** @group Events */
  final case class Success(sql: String, args: List[Any], label: String, exec: FD, processing: FD) extends LogEvent
  ...
  /** @group Events */
  final case class ExecFailure(sql: String, args: List[Any], label: String, exec: FD, failure: Throwable)
      extends LogEvent
